    ...
    <div class="auth-container">
      ...
      <div class="auth-card">
        ...
        <div v-if="akunDihapus" class="alert alert--info">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="#2563eb" stroke-width="2"/><line x1="12" y1="8" x2="12" y2="12" stroke="#2563eb" stroke-width="2" stroke-linecap="round"/><circle cx="12" cy="16" r="1" fill="#2563eb"/></svg>
          Akun Anda telah dihapus. Data magang sudah dikirim ke email terdaftar.
        </div>
