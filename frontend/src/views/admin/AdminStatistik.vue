        ...
        <div class="card">
          ...
          <div class="empty-state">
            <div class="empty-state__icon"><svg width="36" height="36" viewBox="0 0 24 24" fill="none">
                ...
                <line x1="2" y1="12" x2="22" y2="12" stroke="#d1d5db" stroke-width="1.5" />
              </svg></div>
      ...
      <template v-else-if="activeTab === 'faq'">
        <div class="card">
          ...
          <div class="empty-state">
            <div class="empty-state__icon"><svg width="36" height="36" viewBox="0 0 24 24" fill="none">
                <circle cx="12" cy="12" r="10" stroke="#d1d5db" stroke-width="1.5" />
                <path d="M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3" stroke="#d1d5db" stroke-width="1.5" stroke-linecap="round" />
                <line x1="12" y1="17" x2="12.01" y2="17" stroke="#d1d5db" stroke-width="2" stroke-linecap="round" />
              </svg></div>
...
.welcome-banner__badge {
  background: rgba(72, 175, 74, 0.25);
...
.quick-card:hover {
  border-color: #48AF4A;
  box-shadow: 0 4px 14px rgba(72, 175, 74, 0.12);
}
