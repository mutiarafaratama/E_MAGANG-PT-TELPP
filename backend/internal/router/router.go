...
func Setup() *gin.Engine {
        ...
        emailSvcAuth  := service.NewEmailService()
        authSvc       := service.NewAuthService(userRepo, emailSvcAuth)
        ...
        absensiH      := handler.NewAbsensiHandler(absensiRepo, pelaksanaanRepo, pengajuanRepo, absensiConfigRepo, divisiRepo, notifSvc)
        absensiConfigH := handler.NewAbsensiConfigHandler(absensiConfigRepo)
        izinSakitH    := handler.NewIzinSakitHandler(izinSakitRepo, pelaksanaanRepo, notifSvc)
        ...
        laporanSvc    := service.NewLaporanService(laporanRepo, pelaksanaanRepo, userRepo, notifSvc)
        laporanH      := handler.NewLaporanHandler(laporanSvc, laporanRepo, pelaksanaanRepo)
